...
# Form implementation generated from reading ui file 'check_laser_delay.ui'
#
...
"}")
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 271, 78))
...
"}")
        ...
        self.mw_gate_spbx.setMaximum(1000000)
        self.mw_gate_spbx.setProperty("value", 500)
        ...
        self.daq_step_spbx = QtWidgets.QSpinBox(self.groupBox_10)
        self.daq_step_spbx.setMaximum(5000)
        self.daq_step_spbx.setProperty("value", 10)
        self.daq_step_spbx.setObjectName("daq_step_spbx")
        self.gridLayout_6.addWidget(self.daq_step_spbx, 8, 1, 1, 1)
        ...
        self.gridLayout_6.addWidget(self.daq_gate_spbx, 7, 1, 1, 1)
        ...
        self.laser_start_spbx.setMaximum(20000)
        self.laser_start_spbx.setProperty("value", 2000)
...
"}")
        ...
        self.mw_start_spbx.setProperty("value", 3000)
        ...
        self.gridLayout_6.addWidget(self.label_7, 7, 2, 1, 1)
        self.n_sample_spbx = QtWidgets.QSpinBox(self.groupBox_10)
        self.n_sample_spbx.setMaximum(5000)
        self.n_sample_spbx.setProperty("value", 1000)
        self.n_sample_spbx.setObjectName("n_sample_spbx")
        self.gridLayout_6.addWidget(self.n_sample_spbx, 7, 3, 1, 1)
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 575, 69))
        ...
        self.scrollAreaWidgetContents_3.setGeometry(QtCore.QRect(0, 0, 890, 69))
    ...
    def retranslateUi(self, Form):
        ...
        self.label_15.setText(_translate("Form", "DaqStep(ns):"))
        ...
        self.label_7.setText(_translate("Form", "n sample:"))
